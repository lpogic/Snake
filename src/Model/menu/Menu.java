...
//        Apk.manager.add(new Test());
        Snake snake1 = makeMouseControlledSnake(100f, 100f, 4, 0, Apk.applet.LEFT, Apk.applet.RIGHT);
        Snake snake2 = makeKeyboardControlledSnake(600f, 500f, -4, 0, KeyEvent.VK_LEFT,KeyEvent.VK_RIGHT);
//        Snake snake = new Snake(new KeyboardController(), 100f, 500f, 4, 0);
        Apk.manager.add(snake1, snake2);
        Apk.manager.add(new FoodSupplier(10));
        Apk.manager.add(this);
    }
